...
# Quartz (generador del sitio con grafo) — tag ESTABLE pineado (master viene roto)
RUN git clone --depth 1 --branch v4.5.2 https://github.com/jackyzha0/quartz /quartz \
    && cd /quartz && npm ci
